...
if __name__ == '__main__':
    ...
    parser.add_argument("-source_root", "--source_root", help = "specify your source dir", default = r"C:\Users\admin\PycharmProjects\DoAn\Face_main\data\take_data\data\student", type = str)
    parser.add_argument("-dest_root", "--dest_root", help = "specify your destination dir", default = r"C:\Users\admin\PycharmProjects\DoAn\Face_main\data\take_data\data\student_aligned", type = str)
