...
def visualize_tsne_images(tx, ty, images, plot_size=1000, max_image_size=100):
    ...
    plt.show()
def get_labels():
    img_path=r"C:\Users\admin\PycharmProjects\FinalDoAn\Face_main\data\student_aligned"
...
def main():
    ...
    for tag in tags:
        images, embeddings = get_embeddings(
            ...
            model_root=r"C:\Users\admin\PycharmProjects\FinalDoAn\Face_main\checkpoint\backbone_ir50_asia.pth",
            input_size=[input_size, input_size], )
        #cv2.imshow("fr", images)
       # cv2.waitKey(0)
    ...
    data={"embeddings": all_embeddings, "names": get_labels()}
